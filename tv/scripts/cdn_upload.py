...
Usage:
  ...
  python tv/scripts/cdn_upload.py posters/2025-12-21/overall.png

  # Upload entire directory
  python tv/scripts/cdn_upload.py posters/2025-12-21/

  # Upload with custom remote path
  python tv/scripts/cdn_upload.py local.png --remote posters/custom/image.png

  # Dry run (show what would be uploaded)
  python tv/scripts/cdn_upload.py posters/2025-12-21/ --dry-run

  # Return URLs as JSON (for pipeline integration)
  python tv/scripts/cdn_upload.py posters/2025-12-21/ --json
